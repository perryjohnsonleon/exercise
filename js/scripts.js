                  ...
                  $.each(data,function(key1,item1){
                    ...
                    $.each(itemData,function(key2,item2){
                    	if (key2  === 'quote' ) {
                             ...
                             if (key3 === '200009') {
                 	           $("#span11").html("<button class='btn-expand' onclick='showElement(" + stockId_list[0] + ");'>" + item3 + "</button>"); 
                             }
                             if (key3 === '6') {
                 	           $("#span12").html(item3);}
                             if (key3 === '11') {
                  ...
                  $.each(data,function(key11,item11){
                    ...
                    $.each(itemData11,function(key21,item21){
                    	if (key21  === 'quote' ) {
                             ...
                             if (key31 === '200009') {
								$("#span21").html("<button class='btn-expand' onclick='showElement(" + stockId_list[1] + ");'>" + item31 + "</button>"); 
                             }
                             if (key31 === '6') {
                 	              $("#span22").html(item31); 
                             }
                    ...
                    $.each(itemData11,function(key21,item21){
                    	if (key21  === 'quote' ) {
                    		 ...
                    		 // console.log(itemData21); 	
                    		  $.each(itemData21,function(key31,item31){  
                             if (key31 === '200009') {
								$("#span31").html("<button class='btn-expand' onclick='showElement(" + stockId_list[2] + ");'>" + item31 + "</button>");                              }
                             if (key31 === '6') {
                 	              $("#span32").html(item31); 
                             }
                             if (key31 === '11') {
               ...
               $.each(itemData11,function(key21,item21){
                 if (key21  === 'quote' ) {
                    ...
                    // console.log(itemData21); 	
                     $.each(itemData21,function(key31,item31){  
                        if (key31 === '200009') {
						   $("#span41").html("<button class='btn-expand' onclick='showElement(" + stockId_list[3] + ");'>" + item31 + "</button>");                         }
                        if (key31 === '6') {
                            $("#span42").html(item31); 
                        }
                        if (key31 === '11') {
               ...
               $.each(itemData11,function(key21,item21){
                 if (key21  === 'quote' ) {
                    ...
                    // console.log(itemData21); 	
                     $.each(itemData21,function(key31,item31){  
                        if (key31 === '200009') {
							$("#span51").html("<button class='btn-expand' onclick='showElement(" + stockId_list[4] + ");'>" + item31 + "</button>");                         }
                        if (key31 === '6') {
                            $("#span52").html(item31); 
                        }
                        if (key31 === '11') {
          ...
          $.each(data,function(key11,item11){
            ...
            $.each(itemData11,function(key21,item21){
                if (key21  === 'quote' ) {
                      ...
                      $.each(itemData21,function(key31,item31){  
                     if (key31 === '200009') {
						   $("#op11").html("<button class='btn-expand' onclick='showElement(" + stockId_list[5] + ");'>" + item31 + "</button>");                      }
                     if (key31 === '6') {
                           $("#op12").html(item31); 
                     }
                     if (key31 === '11') {
  ...
  // @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ Begin
   ...
   function step13() {
        ...
        for (let i = 0; i < itemYear_arry11.length; i++) {
		    ...
		    show_YearRpt='<table width="33%" style="color: rgb(132, 141, 151); font-size: 14px; text-align: right;">' + '<thead><tr><td style="width:33%;color:#eb9b34">[' + itemYear_stockname + ']月財報</td><td style="width:25%">營收(千元)</td><td style="width:33%">年增率</td></thead><tbody>' + tr_line  + '</tbody></table>'  ;
        // ~~~~~ insert before
        tr_line =""
        var item2currency=0;
